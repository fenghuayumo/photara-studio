...
int main() {
    using photara::parallel::parallel_for;
    const unsigned threads =
        std::min(8U, photara::parallel::hardware_threads());
    ...
    if (photara::parallel::parallel_for_grain(10000, threads) < 32) {
    ...
    auto& pool = photara::parallel::global_thread_pool();
    ...
    {
        photara::parallel::ThreadPool empty_pool(0);
    ...
    {
        photara::parallel::FutureGroup group;
