...
#if !defined(PHOTARA_RECONSTRUCTION_CACHE_BUILD_ID)
#define PHOTARA_RECONSTRUCTION_CACHE_BUILD_ID "unconfigured"
#endif
...
std::uint64_t reconstruction_key(
    ...
    key.append_string(PHOTARA_RECONSTRUCTION_CACHE_BUILD_ID);
