...
int main(int argc, char** argv) {
    try {
        if (argc != 4) {
            std::cout << "Usage: photara_pair_verify image0 image1 focal_pixels\n";
            return argc == 1 ? 0 : 1;
        }
        double focal = 0.0;
        ...
        auto extractor = photara::features::create_extractor("sift");
        auto matcher = photara::features::create_matcher("sift");
        ...
        photara::sfm::PinholeCamera camera0;
        ...
        photara::sfm::PinholeCamera camera1 = camera0;
        ...
        std::vector<photara::sfm::Vec2> p1, p2;
        ...
        const auto geometry =
            photara::sfm::estimate_relative_pose(p1, p2, camera0, camera1, options);
