...
namespace tinytensor {
    ...
    class PHOTARA_CORE_API CudaMemoryPool {
    public:
        static CudaMemoryPool& instance();

        class PHOTARA_CORE_API LabelGuard {
        public:
    ...
    private:
        ...
        void track_allocation(void* ptr, size_t size, AllocMethod method) {
            ...
            try {
                tinytensor::VramProfiler::instance().recordAllocation(
        ...
        void untrack_allocation(void* ptr) {
            ...
            try {
                tinytensor::VramProfiler::instance().recordDeallocation(ptr);
            } catch (...) {
        ...
        static tinytensor::VramAllocationMethod to_vram_method(AllocMethod method) {
            switch (method) {
            case AllocMethod::Slab: return tinytensor::VramAllocationMethod::Slab;
            case AllocMethod::Bucketed: return tinytensor::VramAllocationMethod::Bucketed;
            case AllocMethod::Async: return tinytensor::VramAllocationMethod::Async;
            case AllocMethod::Direct: return tinytensor::VramAllocationMethod::Direct;
            }
            return tinytensor::VramAllocationMethod::Unknown;
        }
