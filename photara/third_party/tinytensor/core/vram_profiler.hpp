...
namespace tinytensor {
    ...
    // Empty export macro for static library build
    #define TINYTENSOR_DIAGNOSTICS_API
    ...
    class TINYTENSOR_DIAGNOSTICS_API VramScope {
    public:
    ...
    class TINYTENSOR_DIAGNOSTICS_API VramDeltaScope {
    public:
    ...
    class TINYTENSOR_DIAGNOSTICS_API TraceScope {
    public:
    ...
    class TINYTENSOR_DIAGNOSTICS_API GpuTimeScope {
    public:
    ...
    class TINYTENSOR_DIAGNOSTICS_API VramProfiler {
    public:
...
#define TINYTENSOR_DIAGNOSTICS_CONCAT_INNER(a, b) a##b
#define TINYTENSOR_DIAGNOSTICS_CONCAT(a, b)       TINYTENSOR_DIAGNOSTICS_CONCAT_INNER(a, b)
#define TINYTENSOR_VRAM_SCOPE(name) \
    ::tinytensor::VramScope TINYTENSOR_DIAGNOSTICS_CONCAT(_tinytensor_vram_scope_, __LINE__)(name)
#define LOG_VRAM_DIFF(name) \
    ::tinytensor::VramDeltaScope TINYTENSOR_DIAGNOSTICS_CONCAT(_tinytensor_vram_delta_scope_, __LINE__)(name)
#define TINYTENSOR_TRACE(name) \
    ::tinytensor::TraceScope TINYTENSOR_DIAGNOSTICS_CONCAT(_tinytensor_trace_scope_, __LINE__)(name)
#define TINYTENSOR_GPU_TIME(name, stream)                                                           \
    ::tinytensor::GpuTimeScope TINYTENSOR_DIAGNOSTICS_CONCAT(_tinytensor_gpu_time_scope_, __LINE__)( \
        name, static_cast<void*>(stream))
#define TINYTENSOR_GAUGE(key, value) \
    ::tinytensor::VramProfiler::instance().setGauge(key, static_cast<double>(value))
#define TINYTENSOR_COUNTER_ADD(key, n)                                                            \
    ::tinytensor::VramProfiler::instance().addCounter(key,                           \
                                                            static_cast<std::uint64_t>(n), \
                                                            true)
#define TINYTENSOR_COUNTER_TOTAL_ADD(key, n)                                                      \
    ::tinytensor::VramProfiler::instance().addCounter(key,                           \
                                                            static_cast<std::uint64_t>(n), \
                                                            false)
#define TINYTENSOR_HIST(key, value) \
    ::tinytensor::VramProfiler::instance().recordHistogram(key, static_cast<double>(value))
