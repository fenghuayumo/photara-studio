...
static_assert(static_cast<uint8_t>(tinytensor::internal::LazyPointwiseOpKind::AddScalar) == 0);
static_assert(static_cast<uint8_t>(tinytensor::internal::LazyPointwiseOpKind::Abs) == 10);
static_assert(static_cast<uint8_t>(tinytensor::internal::LazyPointwiseOpKind::Round) == 24);
