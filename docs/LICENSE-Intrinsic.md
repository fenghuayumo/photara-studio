# Intrinsic model license note

The Intrinsic delighter ONNX weights (`stage_0.onnx` .. `stage_3.onnx`) are
derived from [compphoto/Intrinsic](https://github.com/compphoto/Intrinsic)
