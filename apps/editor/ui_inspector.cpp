    ...
    if (ImGui::CollapsingHeader(
        ...
        if (ImGui::TreeNodeEx(
            ...
            if (theme::toolbar_button(tr("Clean unused caches"), {-1.F, 0.F})) {
                ...
                if (removed == 0) {
                    set_message(
                        app, "No unused cache folders to clean",
                        theme::text_muted);
                } else {
                    char text[200];
                    std::snprintf(
            ...
            if (auto_clean) {
                ...
                if (ImGui::InputInt(
                        ...
                        &app.settings.cache_retention_days, 1, 7)) {
