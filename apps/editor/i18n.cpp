...
constexpr Entry k_entries[] = {
    ...
    {"GPU-first photogrammetry for photos, video, and 3DGS",
     "面向照片、视频与 3DGS 的 GPU 优先摄影测量",
     "写真・動画・3DGS 向けの GPU ファースト写真測量",
     "사진, 동영상, 3DGS를 위한 GPU 우선 사진측량"},
    {"Version", "版本", "バージョン", "버전"},
    {"Engine", "引擎", "エンジン", "엔진"},
    {"Photara reconstruction engine", "Photara 重建引擎", "Photara 再構成エンジン", "Photara 재구성 엔진"},
