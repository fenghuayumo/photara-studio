            ...
            for (int i = skip_frames; i < std::min(frames, skip_frames + 10); ++i) {
                ...
                if (start != std::string::npos && end != std::string::npos && end > start + 1) {
                    ...
                    if (status == 0 && demangled) {
                        ...
                        if (func.find("tinytensor::Tensor") != std::string::npos ||
                            func.find("tinytensor::tensor") != std::string::npos ||
                            func.find("tinytensor::TensorImpl") != std::string::npos ||
                            func.find("tinytensor::internal") != std::string::npos ||
                            func.find("tinytensor::Application::run") != std::string::npos ||
                            func.find("tinytensor::run_headless_app") != std::string::npos ||
